variable "snowflake_secrets_path_prefix" {
  description = "The path prefix for the Snowflake secrets in AWS Secrets Manager."
  type        = string
}

variable "secrets_insert" {
  description = "The name of the secrets to be inserted."
  type        = string
}
